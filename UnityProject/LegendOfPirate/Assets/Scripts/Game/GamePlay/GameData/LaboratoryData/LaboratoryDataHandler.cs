...
{
	public class LaboratoryDataHandler :DataHandlerBase<LaboratoryData>,IDataHandler
	{
        private const string DATA_NAME = "LaboratoryData";
        public LaboratoryDataHandler() 
        {
