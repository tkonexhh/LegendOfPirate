...
namespace GameWish.Game
{
    ...
    public class CommodityDBData
    {
        ...
        public CommodityDBData(BlackMarketConfig blackMarketConfig) : this(blackMarketConfig.id, blackMarketConfig.marketConfigItem.id, blackMarketConfig.marketConfigItem.count)
        {
        }
    }
}