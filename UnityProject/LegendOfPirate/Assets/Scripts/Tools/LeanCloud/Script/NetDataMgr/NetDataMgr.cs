...
namespace GameWish.Game
{
    ...
    public class NetDataMgr : TSingleton<NetDataMgr>, INetDataHandler
    {
        ...
        public bool SaveNetData(string className, object data) { return netDataHandler.SaveNetData(className, data); }
        ...
        public void LoadNetData(string className, Action<string> callback1, Action callback2) { netDataHandler.LoadNetData(className, callback1, callback2); }

        ///<summary>
        /// 处理数据
        ///</summary>
        public string DealData() { return netDataHandler.DealData(); }
    }
}