...
namespace GameWish.Game
{
    ...
    public class NetDataMgr : TSingleton<NetDataMgr>, INetDataHandler
    {
        ...
        {
            return netDataHandler.SaveNetData(className, data, successCallBack, failCallBack);
        }
        ...
        public void LoadNetData(string className, Action<string> callback1, Action callback2, Action successCallBack = null, Action failCallBack = null)
        {
            netDataHandler.LoadNetData(className, callback1, callback2, successCallBack, failCallBack);
        }
