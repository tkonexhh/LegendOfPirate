...
namespace GameWish.Game
{
    public sealed class ConsoleWindow : IDebuggerWindow
    {
        ...
        private void OnLogMessageReceived(string logMessage, string stackTrace, LogType logType)
        {
            ...
            while (m_LogNodes.Count > m_MaxLine)
            {
                ...
                ObjectPool<LogNode>.S.Recycle(m_LogNodes.Dequeue());
            }
        }
    ...
    /// 日志记录结点。
    /// </summary>
    public sealed class LogNode : ICacheAble
    {
        ...
        {
            LogNode logNode = Qarth.ObjectPool<LogNode>.S.Allocate();
